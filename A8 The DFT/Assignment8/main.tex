...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig1.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig2.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig3.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
   	\caption{DFT of $cos^3(t)$}
   	\label{fig:sample}
   \end{figure} 
 \begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig4.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig5.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig6.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig7.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig8.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
...
\begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig9.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
 ...
 \begin{figure}[!tbh]
   	\centering
   	\includegraphics[scale=0.8]{fig10.png}  % Mention the image name within the curly braces. Image should be in the same folder as the tex file. 
